...
namespace CutItUp.Data.Migrations
{
    ...
    [Migration("20250408073724_AddListPartAndTitleDescriptionPartTables")]
    partial class AddListPartAndTitleDescriptionPartTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CutItUp.Data.Data.CMS.ListPart", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("ListContent")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
